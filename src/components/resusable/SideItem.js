        ...
        <Fragment>
            ...
            <div style={{...props.style}} className="sidebar_side_item">
               <div className="checkbox_box">
                    <input type="checkbox" id={props.firstOne} value={props.firstOne} name={props.firstOne} />
                    <label for={props.firstOne}> {props.firstOne} </label>
                </div>

                <div className="checkbox_box">
                   <input type="checkbox" id={props.secondOne} value={props.secondOne} name={props.secondOne}  />
                   <label for={props.secondOne}> {props.secondOne}  </label>
                </div>

                <div style={{...props.thirdBoxStyle}} className="checkbox_box">
                    <input type="checkbox" id={props.thirdOne} value={props.thirdOne} name={props.thirdOne} />
